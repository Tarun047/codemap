...
from src.database.graph.configuration import GraphDatabaseConfiguration
...
config = GraphDatabaseConfiguration('bolt://localhost:7687', username='neo4j', password='develop123', database='neo4j')
...
RETURN d.id as dependency_name
